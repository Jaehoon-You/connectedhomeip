...
object DeepLink {
    ...
    fun getDeepLinkRequestFromDevice(device: Device, setting: String): NavDeepLinkRequest {
        ...
        val uri =
            when (device) {
                Device.OnOffSwitch -> "android-app://com.matter.virtual.device.app.feature.control/onOffSwitchFragment/${setting}".toUri()
                Device.DoorLock -> "android-app://com.matter.virtual.device.app.feature.closure/doorLockFragment/${setting}".toUri()
